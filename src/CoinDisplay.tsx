...
function CoinDisplay() {
  return (
    <div className="w-full h-auto bg-black px-4 py-10 text-white font-inter flex flex-col items-center justify-center">
      <div className="w-3/4 flex flex-col items-center justify-center gap-30">
        <div className="w-1/2 flex flex-col items-center justify-center gap-12">
          ...
          >
            <div className="body-heading text-5xl text-center font-semibold">
